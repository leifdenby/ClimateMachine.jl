...
`boundary_state!` method for the land model when Neumann conditions 
are used.
"""
function boundary_state!(
    ...
    land_soil_water_boundary_state!(nf, land.soil.water, args...)
    land_soil_heat_boundary_state!(nf, land.soil.heat, args...)
end
...
`boundary_state!` method for the land model when Dirichlet conditions 
are used.
"""
function boundary_state!(
    nf,
